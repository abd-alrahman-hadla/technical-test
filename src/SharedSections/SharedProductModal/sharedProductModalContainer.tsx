        ...
        >
            ...
            <div className={"bg-white rounded-[8px] h-[330px] relative mt-[160px]"}>
                ...
                <div className={"pt-[130px] flex-1 flex-col-center gap-[8px]"}>
                    <Title className={"!text-secondaryColor !text-[16px] !font-bold"}>
                        {data?.name}
                    </Title>
                ...
                <div
                    className={"bg-primaryColor h-[54px] flex-center w-[87%] absolute bottom-[-25px] mx-[24px] rounded-[8px] mt-auto"}>
